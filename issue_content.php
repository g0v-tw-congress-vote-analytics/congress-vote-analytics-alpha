...
if($_SESSION['username'] != null)
{
		...
		echo '<h3>議題表態</h3><br/>';
		//將資料庫裡的所有留言資料顯示在畫面上
		$sql1 = "SELECT vote, scale FROM  `ivsm` where isid = '$issueid' and mid = '$userid' ";
		...
		echo "議題名稱： $row2[1]";
			if($row[0]==null){
				echo "<form name=\"form\" method=\"post\" action=\"insert_issue.php?action=ins_ivsm\">";
			}else{
				echo "<form name=\"form\" method=\"post\" action=\"insert_issue.php?action=upd_ivsm\">";
			}
